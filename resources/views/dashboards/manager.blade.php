...
<body class="bg-white text-gray-800 dark:bg-[#121212] dark:text-white min-h-screen transition-colors duration-200">
    ...
    <section class="w-full bg-transparent">
        <div class="flex min-h-screen w-full items-center justify-center p-6 text-center text-9xl font-bold font-playfair tracking-tight leading-tight text-stone-100">
